...
set_kv "config/development/identity-service/keycloak.clientSecret" "zYpP1P4v3fEpq0zJmi8mWi7y3sCwN6S0"
...
set_kv "config/development-local/identity-service/keycloak.clientSecret" "zYpP1P4v3fEpq0zJmi8mWi7y3sCwN6S0"
